...
public class Game {
    ...
    public static void main(String[] args) throws FileNotFoundException {
            ...
            // Creating NPCs
            // Tavern NPC
            NPC Trish = new NPC("Trish", 0000, 0, 5, 0);
            // Kingdom NPC
            NPC Princess = new NPC("Princess Seraphina", 0010, 7, 5, 8);
            // Forest NPC
            NPC Nedali = new NPC("Nedali", 1000, 4, 5, 6);
            // Village NPC
            NPC Mei = new NPC("Mei", 0001, 7, 5, 6);
            ...
            do {
                ...
                if (Player.health < 1){
                ...
                else if (characterType == "merchant" && Player.getTrades()>5 && Player.getWealth()>100){
                    ...
                    System.out.println("Your health is low! Try eating or drinking something.");
                }
